 ...
 */
export const generateReport = async (reportGenerateInput?: ReportGenerateInput, options?: RequestInit): Promise<ReportOutput> => {

  return customFetch<ReportOutput>(getGenerateReportUrl(),
  {
    ...options,
    method: 'POST',
...
export const getGenerateReportMutationOptions = <TError = ErrorType<ReportError>,
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type GenerateReportMutationBody = BodyType<ReportGenerateInput> | undefined
    export type GenerateReportMutationError = ErrorType<ReportError>

    /**
 * @summary Generate a Global IPO Intelligence Report using Gemini AI
 */
export const useGenerateReport = <TError = ErrorType<ReportError>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof generateReport>>, TError,{data?: BodyType<ReportGenerateInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
